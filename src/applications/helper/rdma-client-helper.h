...
public:
  ...
  RdmaClientHelper (uint16_t pg, Ipv4Address sip, Ipv4Address dip, uint16_t sport, uint16_t dport, uint64_t size, uint32_t win, uint64_t baseRtt, uint32_t qpid, uint32_t msgSeq, uint32_t src, uint32_t dst, uint32_t flow_id, bool testFlow = false);
...
//  RdmaClientHelper (uint16_t pg, Ipv4Address sip, Ipv4Address dip, uint16_t sport, uint16_t dport, uint64_t size, uint32_t win, uint64_t baseRtt);
  ...
  void SetDstNode(Ptr<Node> dst_node);
