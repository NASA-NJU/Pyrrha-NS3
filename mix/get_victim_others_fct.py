...
out_file = open(out_pth+"/get_victime_others_fct.data",'w')
out_file2 = open(out_pth+"/get_victime_others_slowdown.data",'w')
...
for ff in file_list:
    if pattern in ff:
        ...
        fct_pd = fct_pd[[0,1,9,11]] #srcid, dstid, fct, slowdown
        fct_pd.columns=['srcid','dstid','fct','slowdown']
        print(fct_pd.info()) 
        # print(fct_pd)
